...
def parse_version(version):
    ...
    major, minor, patch = (version >> 8) & 0xFF, version & 0xFF, 0
...
if not args.ptype is None:
    ...
    if ptype is None:
        parser.error(f'invalid program type: {args.ptype}')
...
try:
    ...
    traceback.print_exc()
    print('')
    parser.error(f'unable to save fself file: {fself_file_path} ({err})')
